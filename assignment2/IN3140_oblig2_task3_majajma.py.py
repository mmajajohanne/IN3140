...
def jacobian(joint_angles, joint_velocities):
    ...
    parameters:
        joint_angles (list): joint angles [theta1, theta2, theta3]
        joint_velocities (list): joint angular velocities [theta1_dot, theta2_dot, theta3_dot]
    ...
    cart_velocities = np.round(cart_velocities, 4)

    return cart_velocities

# b
joint_angles = [180,30,-45]
